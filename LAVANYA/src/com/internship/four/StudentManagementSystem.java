...
public class StudentManagementSystem {
	public static void main(String[]args) {
		...
		int totalStudents=0;
		try {
			student[0]=new UndergraduateStudent("UG001","John doe","ComputerScience",3.5);
			totalStudents++;
		...
		try {
			student[3]=new UndergraduateStudent("UG004","Jane Rao","Engineering",5.0);
			totalStudents++;
		...
		try {
			student[4]=new PhDStudent("PHD002","Dr.Grass Hopper","Computer Science",3.2);
			totalStudents++;
		}catch(InvalidGPAException e) {
